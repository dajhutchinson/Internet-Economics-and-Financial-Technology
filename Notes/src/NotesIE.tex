...
\begin{proposition}{Values in an Auction}
  Each bidder has their own \textit{``private''} value which is the amount they are willing to pay (at most) for an item. Ideally a bidder will pay below this value.
\end{proposition}
...
\begin{definition}{English Auction}
  Used in \textit{Homes under the Hammer}.
  \begin{enumerate}
...
\begin{definition}{Dutch Auction}
  Used in \textit{Dutch Flower Markets}.
  \begin{enumerate}
