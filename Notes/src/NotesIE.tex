...
\begin{proposition}{Intelligence required for an allocative efficient CDA}
  ...
  \par \textit{Experimental Economics} demonstrated than a zero-intelligence trading agent which quoted random prices (but constrained not to trade at a loss) is surprisingly human-like. Suggesting most of the the intelligence is in the market, not in the traders.
\end{proposition}
